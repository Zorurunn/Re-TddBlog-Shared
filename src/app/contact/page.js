        ...
        <div className="w-[70%] flex flex-col gap-[50px]">
          ...
          <div className="w-full bg-gray-50 rounded-[20px]  p-[30px] flex flex-col gap-[40px]">
            ...
            <div className="grid grid-cols-2 gap-[40px] w-[80%]">
              ...
              />
              <input
                className="border-[2px] col-span-2 h-[40px]"
                placeholder="First Name"
              />
              <input
                className="border-[2px]  col-span-2 h-[40px]"
            ...
            <div className="cursor-pointer bg-blue-500 text-white w-fit rounded-[5px] pl-[10px] pr-[10px] pt-[5px] pb-[5px]">
              Send Message
            </div>
          </div>
        </div>
